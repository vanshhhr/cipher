...
<body>
    <div class="drawer-container">
        <div class="drawer-content">
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link drawer-link" href="#">Order Details</a>
                </li>
            </ul>
        </div>
    </div>
    <div class="container-fluid ">
        <div class="row p-5">
            <div class="col-10">
                <div class="row pt-3">
                    <div class="col-auto fw-bold" style="font-size: larger;">Order Details</div>
                </div>
                <div class="row pt-3">
                    <div class="col-2"><label>Order Detail Id</label></div>
                    <div class="col-auto"><input class="mandatory" type="text" id="orderDetailId" name="Order Detail Id"><span></span></div>
                </div>
                <div class="row pt-3">
                    <div class="col-2"><label>Order Id</label></div>
                    <div class="col-auto">
                        <select class="selectOption px-2" id="orderId" name="Order Id">
                            <option value="0" selected>--- Open to select ---</option>
                            <option value="1">Order_Id__1</option>
                            <option value="2">Order_Id__2</option>
                            <option value="3">Order_Id__3</option>
                        </select>
                        <span></span></div>
                </div>
                <div class="row pt-3">
                ...
                <div class="row pt-3">
                    ...
                    <div class="col-auto"><input class="int" type="text" id="unitPrice" name="Unit Price"><span></span></div>
                </div>
                <div class="row pt-3">
                    <div class="col-2"><label>Description</label></div>
                    <div class="col-auto"><input class="mandatory" type="text" id="descript" name="Description"><span></span></div>
                </div>
                <div class="row pt-3">
                    <div class="col-auto">
    ...
    selectMenu = document.getElementsByClassName("selectOption"); 
    ...
    function submitForm(){
        ...
        for (i = 0; i < selectMenu.length; i++){
            if(selectMenu[i].selectedIndex == 0){
                selectMenu[i].nextElementSibling.innerHTML = "* Select one "+selectMenu[i].name + " *";
                filled = false;
            }else{
                selectMenu[i].nextElementSibling.innerHTML = "";
            }
        }
        if (filled == true){
            alert("Form Submited");
