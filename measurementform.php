...
<body>
    <div class="drawer-container">
        <div class="drawer-content">
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link drawer-link" href="#">Measurement Unit</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container-fluid ">
        <div class="row p-5">
            <div class="col-10">
                <div class="row pt-3">
                    <div class="col-auto fw-bold" style="font-size: larger;">Measurement Unit</div>
                </div>
                <div class="row pt-3">
                    <div class="col-2"><label>Unit Id</label></div>
                    <div class="col-auto"><input class="mandatory" type="text" id="unitId" name="Unit Id"><span></span></div>
                </div>
                <div class="row pt-3">
                    <div class="col-2"><label>Unit Name</label></div>
                    <div class="col-auto"><input class="mandatory" type="text" id="unitName" name="Unit Name"><span></span></div>
                </div>
                <div class="row pt-3">
    ...
    <script>
        ...
        selectMenu = document.getElementById("itemId");
        filled = true;
        function submitForm(){
            filled = true;
            ...
            if(selectMenu.selectedIndex == 0){
                selectMenu.nextElementSibling.innerHTML = "* Select one "+ selectMenu.name + " *";
                filled = false;
            }else{
