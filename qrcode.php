...
<body>
    <div class="drawer-container">
        <div class="drawer-content">
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link drawer-link" href="#">QR Code</a>
                </li>
            </ul>
        </div>
    </div>
    <div class="container-fluid ">
        <div class="row p-5">
            <div class="col-10">
                <div class="row pt-3">
                    <div class="col-auto fw-bold" style="font-size: larger;">QR Code</div>
                </div>
                <div class="row pt-3">
                    <div class="col-2"><label>QR Code Id</label></div>
                    <div class="col-auto"><input class="mandatory" type="text" id="qrId" name="QR Code Id"><span></span></div>
                </div>
                <div class="row pt-3">
                    <div class="col-2"><label>QR Code Image</label></div>
                    <div class="col-auto"><input class="mandatory" type="file" id="qrImage" name="QR Code Image"><span></span></div>
                </div>
                <div class="row pt-3">
