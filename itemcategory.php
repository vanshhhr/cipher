...
<body>
    <div class="drawer-container">
        <div class="drawer-content">
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link drawer-link" href="#">Item Category</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link drawer-link" href="itemform.php">Item</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link drawer-link" href="measuremenform.php">Measurement Unit</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link drawer-link" href="supplier.php">Supplier</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container-fluid ">
        <div class="row p-5">
            <div class="col-10">
                <div class="row pt-3">
                    <div class="col-auto fw-bold" style="font-size: larger;">Item Category</div>
                </div>
                <div class="row pt-3">
                    <div class="col-2"><label>Category Id</label></div>
                    <div class="col-auto"><input class="mandatory" type="text" id="categoryId" name="Category Id"><span></span></div>
                </div>
                <div class="row pt-3">
                    <div class="col-2"><label>Category Name</label></div>
                    <div class="col-auto"><input class="mandatory" type="text" id="categoryname" name="Category Name"><span></span></div>
                </div>
                <div class="row pt-3">
                    <div class="col-auto">
